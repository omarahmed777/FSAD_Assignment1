...
public class Controller {
    ...
    public void addStudentData() {
        ...
        if (studIdS.isEmpty() || yearStudyS.isEmpty()) {
            ...
            Student student = new Student(studIdS, yearStudyS, choice1, choice2, choice3);
            StudentData.getInstance().addStudentData(student);
    ...
    public void editStudent(Student stu) {
        ...
        if (result.isPresent() && result.get() == ButtonType.OK) {
            ...
            studentListView.getSelectionModel().select(editStudent); //Selects edited student
        }
    }
}